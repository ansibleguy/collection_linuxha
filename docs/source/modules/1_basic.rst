...
..  csv-table:: Definition
    ...
    "force","boolean","false","false","Make crm proceed with applying changes where it would normally ask the user to confirm before proceeding. This option is mainly useful in scripts, and should be used with care. Force will also hide some output from you or even change the exit-code from 1 to 0 on a 'soft-failure'!"
